...
function boardSingo() {
    ...
    var boardNum = document.getElementById("boardNum").value;
	    if (boardSingoReason=="") {
    		...
    		location.href= address+"/singo/addMyBoardSingo.do?boardNum="+boardNum+"&boardSingoReason="+boardSingoReason;
    	}
}
...
function replySingo(){
	...
	if (replySingoReason=="") {
		...
		location.href= address+"/singo/addMyReplySingo.do?replyNum="+replyNum+"&replySingoReason="+replySingoReason;
	}
